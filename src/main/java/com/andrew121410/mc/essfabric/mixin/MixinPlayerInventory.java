...
public class MixinPlayerInventory {
    ...
    public ItemEntity a(PlayerEntity playerEntity, ItemStack stack, boolean throwRandomly, boolean retainOwnership) {
        return this.player.dropItem(stack, false, false);
    }
}